#####
# Usage: python check_zeros.py
# Identifies identifiers with at least 10, 25, 50, 75, 90 per cent zero instances
# Removes these identifiers and creates new files 'HiSeqV2_Filtered_xx' where xx is one of the above thresholds
#####
...
percent_map = {1:[1, zero_count], 10:[122, zero_count_10], 25:[305, zero_count_25], 50:[609, zero_count_50], 75:[914, zero_count_75], 90:[1096, zero_count_90]}
percent_chosen = [10]
